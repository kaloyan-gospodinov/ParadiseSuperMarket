...
{
	public partial class OpenAccessMySQL : OpenAccessContext, IOpenAccessMySQLUnitOfWork
	{
		private static string connectionStringName = @"Paradise_super_systemConnection";
			
		private static BackendConfiguration backend = GetBackendConfiguration();
				
		private static MetadataSource metadataSource = XmlMetadataSource.FromAssemblyResource("EntitiesModel.rlinq");
		
		public OpenAccessMySQL()
			:base(connectionStringName, backend, metadataSource)
		{ }
		
		public OpenAccessMySQL(string connection)
	...
	public interface IOpenAccessMySQLUnitOfWork : IUnitOfWork
	{
